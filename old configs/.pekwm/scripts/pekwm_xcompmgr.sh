...
if [ ! "$(pidof xcompmgr)" ]; then
    ...
    echo "Dynamic {"
    echo " Entry = \"full opacity\" { Actions = \"Exec transset-df 1 \" } "
    echo " Entry = \"75% opacity\" { Actions = \"Exec transset-df .75 \" } "
    echo " Entry = \"50% opacity\" { Actions = \"Exec transset-df .50 \" } "
    echo " Entry = \"25% opacity\" { Actions = \"Exec transset-df .25 \" } "
